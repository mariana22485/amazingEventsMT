...
function createUpcomingEvents(arrayCards,fechaHoy) {
    let cardsEvent = ""
...
inputTexto.addEventListener("input", () => {
    ...
    console.log(containerCard)
        ...
        containerCard.innerHTML = createUpcomingEvents(arregloFiltrarPorCategoria, data.currentDate)
    }
...
function refrescarContenido(){
      ...
      containerCard.innerHTML=createUpcomingEvents(filtrarPorCategoria(data.events), data.currentDate);
}
